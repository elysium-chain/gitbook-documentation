...
You can learn more about the unique [tokenomics](elysium/tokenomics/), [network layer](architecture/network-layer.md), [consensus](consensus-proof-of-victory/page-3.md), [scaling](elysium/consensus/scaling.md), [wallet](elysium/consensus/wallet.md), and [smart contracts](elysium/smart-contracts/) in the relevant sections. But more important than any technical solution is the problem the computer system solves.
