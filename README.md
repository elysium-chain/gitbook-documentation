...
You can learn more about the unique [tokenomics](broken-reference), [architecture](broken-reference), [consensus](consensus-proof-of-victory/page-3.md), [smart contracts](broken-reference), and [approach to scaling](architecture/scaling/) in the relevant sections. But more important than any technical solution is the problem the computer system solves.
